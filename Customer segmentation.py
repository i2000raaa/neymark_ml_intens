...
# Видно, что классы сбалансированы. Выбранная модель Random Forest с использованием GridSearchCV показала лучший accuracy score на тестовых данных. Значения метрик были бы выше при наличии большей информации о покупателях.
